 ...
 */
final class Version20230417191638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP id, CHANGE idcommande idcommande INT AUTO_INCREMENT NOT NULL, CHANGE userid userid VARCHAR(255) NOT NULL, CHANGE payment payment VARCHAR(255) NOT NULL, CHANGE date date VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD id INT AUTO_INCREMENT NOT NULL, CHANGE idcommande idcommande INT NOT NULL, CHANGE userid userid VARCHAR(50) NOT NULL, CHANGE payment payment VARCHAR(50) NOT NULL, CHANGE date date DATE DEFAULT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
